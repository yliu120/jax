...
register_standard_check(lax_parallel.psend_p)
register_standard_rewrite(lax_parallel.psend_p)
register_standard_check(lax_parallel.precv_p)
register_standard_rewrite(lax_parallel.precv_p)
register_standard_check(lax_parallel.after_all_general_p)
register_standard_rewrite(lax_parallel.after_all_general_p)
